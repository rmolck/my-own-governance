...
|---|---|---|---|---|---|---|
| GOV-001 | Establish the initial public governance baseline and adoption templates. | Bootstrap repository; owner task specification. | AI_REVIEW | AI | `codex/inicializar-gobernanza-para-repositorio-personal` / [PR #1](https://github.com/rmolck/my-own-governance/pull/1) | AI rework addressed; current HEAD is ready for renewed supervisor review. |
