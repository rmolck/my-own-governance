...
| GOV-007 | Configure and reproducibly validate the AI SUPERVISOR contract. | GOV-001..GOV-006 `DONE`; [`AUTONOMY.md`](AUTONOMY.md); [`SUPERVISOR_VALIDATION.md`](SUPERVISOR_VALIDATION.md). | WORKING | AI | `gov-007-ai-supervisor` / PR not created | Implementation and deterministic validation are committed locally; branch publication failed because GitHub credentials are unavailable in this execution environment. |
