...
| GOV-013 | Define the reusable adoption and synchronization contract ([issue #22](https://github.com/rmolck/my-own-governance/issues/22)). | GOV-001..GOV-012 `DONE`; GOV-014 `DONE`; [`DOCUMENTATION.md`](DOCUMENTATION.md); [`AUTONOMY.md`](AUTONOMY.md). | DEFERRED | AI | — | HUMAN OWNER explicitly reprioritized GOV-014 before execution began; issue #22 remains valid and returns to `READY` only after GOV-014 and fresh reconciliation. |
| GOV-014 | Define cloud-first orchestration handoffs and manual local wake ([issue #24](https://github.com/rmolck/my-own-governance/issues/24)). | GOV-001..GOV-012 `DONE`; HUMAN OWNER approved the home/developer interaction model and explicit `DEFERRED` state for reprioritized materialized work. | READY | AI | — | Admitted from pilot evidence and explicit HUMAN OWNER workflow preference; contract/reconciliation only, no provider integration or scheduler implementation. |
