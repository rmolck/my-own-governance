...
| GOV-003 | Implement a Codex CLI execution adapter as a reference implementation. | GOV-002 `DONE`; [`EXECUTION.md`](EXECUTION.md). | WORKING | AI | `gov-003-codex-execution-adapter` / pending PR | Implementation in progress. |
