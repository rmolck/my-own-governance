...
| GOV-013 | Define the reusable adoption and synchronization contract ([issue #22](https://github.com/rmolck/my-own-governance/issues/22)). | GOV-001..GOV-012 `DONE`; GOV-014 `DONE`; [`DOCUMENTATION.md`](DOCUMENTATION.md); [`AUTONOMY.md`](AUTONOMY.md). | READY | AI | — | Fresh post-GOV-014 reconciliation confirms dependencies and existing Gate-AI authority permit reactivation; issue #22 remains the substantive contract. |
