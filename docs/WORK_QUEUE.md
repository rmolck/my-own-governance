...
| GOV-004 | Implement a reference Linux runtime using systemd. | GOV-003 `DONE`; [`EXECUTION.md`](EXECUTION.md); existing [`adapter`](../adapter/README.md). | WORKING | AI | `codex/gov-004-systemd-runtime` / pending | Implementation in progress. |
