...
| GOV-005 | Validate heartbeat behavior reproducibly against the autonomous and execution contracts. | GOV-004 `DONE`; [`AUTONOMY.md`](AUTONOMY.md); [`EXECUTION.md`](EXECUTION.md). | WORKING | AI | `codex/gov-005-heartbeat-validation` / pending | Heartbeat behavior validation in progress. |
