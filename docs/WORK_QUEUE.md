...
| GOV-014 | Define cloud-first orchestration handoffs and manual local wake ([issue #24](https://github.com/rmolck/my-own-governance/issues/24)). | GOV-001..GOV-012 `DONE`; HUMAN OWNER approved the home/developer interaction model and explicit `DEFERRED` state for reprioritized materialized work. | AI_REVIEW | AI | `codex/implement-gov-014-from-issue-#24` / PR #26 | Contract and home profile submitted for review; no provider integration or scheduler implementation. |
