...
| GOV-013 | Define the reusable adoption and synchronization contract ([issue #22](https://github.com/rmolck/my-own-governance/issues/22)). | GOV-001..GOV-012 `DONE`; GOV-014 `DONE`; [`DOCUMENTATION.md`](DOCUMENTATION.md); [`AUTONOMY.md`](AUTONOMY.md). | AI_REVIEW | AI | `codex/gov-013-adoption-sync-contract` / PR pending | Contract implemented with revision-pinned provenance, exact-block fail-closed replacement, consumer authority protection, and deterministic validation/no-op semantics; awaiting independent review. |
