...
| GOV-013 | Define the reusable adoption and synchronization contract ([issue #22](https://github.com/rmolck/my-own-governance/issues/22)). | GOV-001..GOV-012 `DONE`; GOV-014 `DONE`; [`DOCUMENTATION.md`](DOCUMENTATION.md); [`AUTONOMY.md`](AUTONOMY.md). | DONE | AI | — | `AI_SUPERVISOR: APPROVED` on substantive HEAD `e01b74690d73602d28ff9bc16e7ae491e9d08c0a`; closure prepared under delegated Gate-AI finalization authority. |
| GOV-014 | Define cloud-first orchestration handoffs and manual local wake ([issue #24](https://github.com/rmolck/my-own-governance/issues/24)). | GOV-001..GOV-012 `DONE`; HUMAN OWNER approved the home/developer interaction model and explicit `DEFERRED` state for reprioritized materialized work. | DONE | AI | — | `AI_SUPERVISOR: APPROVED` on substantive HEAD `16ab6a142a021b206a69be6b6b5644e626d44d28`; closure prepared under delegated Gate-AI finalization authority. |
| GOV-015 | Implement bounded deterministic consumer synchronization tooling ([issue #29](https://github.com/rmolck/my-own-governance/issues/29)). | GOV-013 `DONE`; GOV-014 `DONE`; [`sync/README.md`](../sync/README.md); explicit HUMAN OWNER authorization for JIT admission. | READY | AI | — | HUMAN OWNER authorized the AI ORCHESTRATOR to create the JIT admission PR on 2026-09-25. |
