...
3. Prefer Git-tree work: implementation, tests, refactors, implementation-linked
   ...
   GitHub credentials are not a worker invariant: when publication capability is
   absent, leave an exact local result for the authorized mechanical host phase and
   report that durable publication has not yet occurred.
